(() => {
  ...
  frontend.brickDefinitions = {
    "1": {
      ...
      nodes: [
        { index: 2, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 11, kind: "atom", symbol: "C" },
        { index: 12, kind: "atom", symbol: "C" },
        { index: 4, kind: "port", preferred_brick_type: "SKELETON" },
        ...
        { index: 10, kind: "port", preferred_brick_type: "SKELETON" },
        ...
        { index: 3, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 29, kind: "atom", symbol: "C" },
        { index: 1, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 30, kind: "atom", symbol: "S" },
        { index: 31, kind: "atom", symbol: "C" },
        { index: 5, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 6, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 32, kind: "atom", symbol: "C" },
        { index: 33, kind: "atom", symbol: "C" },
        { index: 9, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 34, kind: "atom", symbol: "C" },
        { index: 7, kind: "port", preferred_brick_type: "SKELETON" },
        { index: 8, kind: "port", preferred_brick_type: "SKELETON" }
      ]
    },
    "2": {
      alias: ["T"],
