...
This project is licensed under the terms of the `MIT` license. See [LICENSE](https://github.com/ConicalBanana/brickene/blob/main/LICENSE) for more details.
...
@misc{brickene,
  author = {none},
  title = {brickene – A flow-graph based visual builder for block-assembled organic molecules.},
  year = {2026},
  publisher = {GitHub},
  journal = {GitHub repository},
  howpublished = {\url{https://github.com/ConicalBanana/brickene}}
}
```
