...
hero:
  name: "brickene"
  text: "brickene – A flow-graph based visual builder for block-assembled organic molecules."
...
- title: 🎯 Modern Python Development
  details: Built with Python 3.9+ and Poetry for robust dependency management and seamless package publishing.
